...
class PermitAgent:
    ...
    def run(self, active_permits: List[Dict], current_time: str = None, current_gas: float = 0.0) -> dict:
        ...
        Args:
            ...
            current_time (str): Optional override for checking expiry.
        ...
        # 1.5 Check for OISD-105 Section 4.3 violation
        for p in active_permits:
        ...
        # 2. Check for OVERLAP of high-risk permits in the same zone
        zone_permits = {}
        for p in active_permits:
            zone = p["zone_id"]
            ...
            if len(p_list) >= 2:
                ...
                if "HOT_WORK" in types and "CONFINED_SPACE" in types:
                    conflicts.append({
                        ...
                        "permit_ids": ids,
                        "zones_affected": [zone],
                        "risk_description": f"Critical overlap: HOT_WORK and CONFINED_SPACE permits are active simultaneously in {zone}.",
                        "severity": "CRITICAL"
                    })
