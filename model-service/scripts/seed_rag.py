"""Script to seed ChromaDB with regulatory documents and historical incidents.
Run this script before starting the model service for the first time.

Usage: python -m scripts.seed_rag
"""
import os
import sys
...
from app.core.utils.doc_parser import extract_text_from_pdf, chunk_text
    ...
    for filename, collection_name in pdf_sources:
        ...
        if os.path.exists(pdf_path):
            ...
            try:
                ...
                if not pages:
                    print(f"No text extracted from PDF {filename}. Loading fallback text...")
